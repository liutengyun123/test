...
#数据集存放的位置
folder_path = r'D:\googleDownload\hpatches-sequences-release\test'
excel1 = r'D:\googleDownload\hpatches-sequences-release\result.xlsx'

# folder_path = r'D:\googleDownload\hpatches-sequences-release\test_vgg'
# excel1 = r'D:\googleDownload\hpatches-sequences-release\result_vgg.xlsx'
...
for item in folders:
    ...
    for filename in os.listdir(item):
        if filename == 'H_1_3' or filename == 'H1to2p':
            ...
            #print(img1,img2)
            recall,precision,F=run_LGSC.run_wgtm(img1,img2,H)
