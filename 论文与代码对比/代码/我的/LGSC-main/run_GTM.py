...
def generate_median_KNN_graph(K, distance_matrix, match_number,ori_dis_mat):
...
def run_gtm(img1,img2,H):
    ...
    while True:
        ...
        ori_adj_matrix = generate_median_KNN_graph(K, ori_dis_mat, match_number,ori_dis_mat)  # the adjacency matrix of ori_graph, Ap
        dst_adj_matrix = generate_median_KNN_graph(K, dst_dis_mat, match_number,ori_dis_mat)  # the adjacency matrix of dst_graph, Ap'
...
if __name__ == '__main__':
    ...
    run_gtm(img1,img2,Hlist1_2)
    # r,p,F = run_gtm(img1,img2,Hlist1_3)
    # print("召回率：",r)
    # print("准确率：",p)
    # print("F-score:",F)
